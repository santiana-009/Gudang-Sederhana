                ...
                <tbody>
                    @foreach ($outgoings as $item)
                        <tr>
                            ...
                            <td>
                                <a href="/pdfoutgoing/{{$item->id}}" class="badge bg-primary">~PDF</a>
                                <a href="/outgoing_end/{{$item->id}}" class="badge bg-warning">~END</a>
                                <form action="/outgoing/{{ $item->id }}" method="POST" class="d-inline">
                                @method('delete')
                                @csrf
